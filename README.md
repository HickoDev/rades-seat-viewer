...
This repository currently contains **Milestone 1: Foundation**. It is not a ticket-booking application, and it does not yet contain the procedural stadium geometry, seats, sunlight simulation, weather forecasts, or heatmap.
