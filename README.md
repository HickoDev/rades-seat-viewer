...
- The lower virages are modeled as stepped terraces without individual chair instances, following project-owner calibration. Clicking either the lower terrace or its larger closed upper-virage area enters the nearest valid lower-terrace POV; no upper-virage visitor position is invented. Exact angular boundaries still require seating plans.
